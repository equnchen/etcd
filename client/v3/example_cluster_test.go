...
func ExampleCluster_memberList() {
	examples.forUnitTestsRunInMockedContext(mockCluster_memberList, func() {
		cli, err := New(Config{
...
func ExampleCluster_memberAdd() {
	examples.forUnitTestsRunInMockedContext(mockCluster_memberAdd, func() {
		cli, err := New(Config{
			Endpoints:   examples.exampleEndpoints(),
			DialTimeout: examples.dialTimeout,
		})
...
func ExampleCluster_memberAddAsLearner() {
	examples.forUnitTestsRunInMockedContext(mockCluster_memberAddAsLearner, func() {
		cli, err := New(Config{
			Endpoints:   examples.exampleEndpoints(),
			DialTimeout: examples.dialTimeout,
		})
...
func ExampleCluster_memberRemove() {
	examples.forUnitTestsRunInMockedContext(mockCluster_memberRemove, func() {
		cli, err := New(Config{
			Endpoints:   examples.exampleEndpoints(),
			DialTimeout: examples.dialTimeout,
		})
...
func ExampleCluster_memberUpdate() {
	examples.forUnitTestsRunInMockedContext(mockCluster_memberUpdate, func() {
		cli, err := New(Config{
			Endpoints:   examples.exampleEndpoints(),
			DialTimeout: examples.dialTimeout,
		})
